...
func Provision(product, module string) (*driver.Cluster, error) {
...
func newCluster(product, module string) (*driver.Cluster, error) {
	c := &driver.Cluster{}
	t := &testing.T{}
...
func Destroy(product, module string) (string, error) {
